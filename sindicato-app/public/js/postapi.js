...
function postApiPosterior(data, page, pageAnterior) {
    $.post('list', data).done(function (response) {
        ...
        response.itens.forEach(function (data) {
            ...
            tr += '<tr>' +
                ...
                '<td>' + data.nome + '</td>' +
                '<td>' +
                '<a href="/app/associado/edit/ ' + data.id + '" class="btn btn-warning btn-circle btn-sm" data-toggle="tooltip" data-placement="left" title="Editar">' +
...
function postApiAnterior(data, pageAnterior, pagePosterior) {
    $.post('list', data).done(function (response) {
...
function postApi(json, page, pageAnterior) {
